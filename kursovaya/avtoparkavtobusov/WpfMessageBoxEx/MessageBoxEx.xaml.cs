...
namespace MsgBoxEx
{
    ...
    public partial class MessageBoxEx : Window, INotifyPropertyChanged
    {
        ...
        public Visibility ShowOk
        {
            get
            {
                return (!this.usingExButtons && this.Buttons == MessageBoxButton.OK ||
        ...
        public Visibility ShowCancel
        {
            get
            {
                return (!this.usingExButtons && this.Buttons == MessageBoxButton.OKCancel ||
        ...
        public Visibility ShowYes
        {
            get
            {
                return (!this.usingExButtons && this.Buttons == MessageBoxButton.YesNo ||
                        !this.usingExButtons && this.Buttons == MessageBoxButton.YesNoCancel ||
        ...
        public Visibility ShowRetry
        {
            get
            {
                return (this.usingExButtons && this.ButtonsEx == MessageBoxButtonEx.AbortRetryIgnore ||
                        this.usingExButtons && this.ButtonsEx == MessageBoxButtonEx.RetryCancel) ? Visibility.Visible : Visibility.Collapsed;
            }
        }
        /// <summary>
