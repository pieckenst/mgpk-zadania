...
type
  TForm5 = class(TForm)
    ...
    ADOTable2Номер: TAutoIncField;
    ADOTable2Дата: TDateTimeField;
    ADOTable2Номер_Рейса: TWideStringField;
    ADOTable2Время_вылета: TDateTimeField;
    ADOTable2Первый_класс: TIntegerField;
    ADOTable2Второй_класс: TIntegerField;
    ADOTable3Номер: TAutoIncField;
    ADOTable3Дата: TDateTimeField;
    ADOTable3Номер_Рейса: TWideStringField;
    ADOTable3Время_вылета: TDateTimeField;
    ADOTable3Первый_класс: TIntegerField;
    ADOTable3Второй_класс: TIntegerField;
    dbeTime: TDBEdit;
    dbeClass1: TDBEdit;
    dbeClass2: TDBEdit;
    Panel1: TPanel;
