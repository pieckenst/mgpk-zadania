...
uses
{$IFnDEF FPC}
  Vcl.Imaging.pngimage, Vcl.StdCtrls, Vcl.ExtCtrls, Vcl.Dialogs, Vcl.Forms, Vcl.Controls, Vcl.Graphics, System.Classes, System.Variants, System.SysUtils, Winapi.Messages, Winapi.Windows, Data.DB, Data.Win.ADODB,
{$ELSE}
{$ENDIF}
  Messages, SysUtils, Variants, Classes, Graphics,
  Controls, Forms, Dialogs, Menus, StdCtrls, DB,
  DBCtrls, ExtCtrls, DBGrids,LCLType, LCLIntf,ReturnBilet;
